...
from blog_agent.utils.image_generator import generate_image
        ...
        for i, img_item in enumerate(planned_images):
            if img_item.section_id == sec_id:
                ...
                try:
                    ...
                    # Convert absolute path to a relative path for the markdown link
                    ...
                    print(f"[Reducer Node] Embedded image for section {sec_id}: {relative_path}")
